...
<body>
    ...
    <main>
        ...
        <div class="quick-actions">
            ...
            <button onclick="location.href='#'">Verify Relationship</button>
        </div>
        <div class="activity">
            <h2>Recent Activity</h2>
            <ul>
                <li>Added new member to family tree</li>
                <li>Shared tree with Blink token: user@example.com</li>
                <li>Generated ancestor report</li>
                <li>Verified relationship with 0x12345...abcde</li>
            </ul>
        </div>
    </main>
</body>
